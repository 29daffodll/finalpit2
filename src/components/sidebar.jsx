    ...
    >
      <div className="p-4">
        ...
        <nav className="space-y-2">
          ...
          >
            <svg className="w-6 h-6 mr-0 text-gray-300 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
            </svg>
            {expanded && <span className="ml-3 font-medium text-gray-300 group-hover:text-white">Inventory Management</span>}
          </a>
        </nav>
      </div>
    </div>
